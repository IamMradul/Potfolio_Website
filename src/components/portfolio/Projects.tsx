...
import { Github, ExternalLink, Shield, Brain, ShoppingCart, Newspaper, Bot } from "lucide-react";
          ...
          {projects.filter((p) => p.featured).map((project, index) => (
            ...
            >
              <CardContainer containerClassName="py-4">
                <CardBody className="bg-card relative group/card border border-border rounded-xl p-6 h-auto w-full">
